...
CREATE TABLE NEGOCIO (
   ...
   CONSTRAINT FK_NEGOCIO_producto FOREIGN KEY (id_producto) REFERENCES PRODUCTO_SERVICIO (id_producto),
    ...
    CONSTRAINT CK_NEGOCIO_inactivo CHECK ( (activo = 1 AND fecha_inactivacion IS NULL) OR
...
CREATE TABLE ACTIVIDAD (
    ...
    CONSTRAINT CK_ACTIVIDAD_completada  CHECK ( (completada = 0 AND fecha_completada IS NULL) OR
