...
INSERT INTO PROSPECTO (nombre_prospecto, celular, correo, fecha_registro, activo) VALUES
...
INSERT INTO NEGOCIO (id_prospecto, id_trabajador, id_fase, id_medio, id_producto, nivel_interes, fecha_registro, ultima_actividad, activo, fecha_inactivacion) VALUES
...
INSERT INTO ACTIVIDAD (id_negocio, id_tipo, id_trabajador, descripcion, fecha_registro, fecha_programada, hora_programada, direccion, completada, fecha_completada) VALUES
    (1,  6, 3, N'Negocio creado',                                          '2025-03-01 09:20:00', NULL,         NULL,       NULL,                 1, '2025-03-01 09:20:00'),
    ...
    (4,  4, 4, N'Llamada de seguimiento, confirmo interes',                '2025-03-11 09:30:00', NULL,         NULL,       NULL,                 1, '2025-03-11 09:30:00'),
    ...
    (7,  1, 3, N'El cliente informa que desistio de la compra',            '2025-03-14 08:45:00', NULL,         NULL,       NULL,                 1, '2025-03-14 08:45:00'),
...
INSERT INTO PROPUESTA (id_negocio, id_trabajador, monto, fecha_propuesta, fecha_vencimiento, estado, observacion) VALUES
...
INSERT INTO AUDITORIA (tabla_afectada, id_registro, operacion, id_trabajador, fecha_operacion, datos_anteriores) VALUES
    ('NEGOCIO',    1, 'INSERT', 3, '2025-03-01 09:20:00', NULL),
    ('NEGOCIO',    3, 'INSERT', 3, '2025-03-02 10:45:00', NULL),
    ('NEGOCIO',    9, 'INSERT', 5, '2025-03-08 12:30:00', NULL),
    ('NEGOCIO',    9, 'DELETE', 2, '2025-03-15 10:00:00', N'{"id_negocio":9,"id_prospecto":8,"id_fase":1,"nivel_interes":2}'),
    ('PROSPECTO',  8, 'UPDATE', 2, '2025-03-15 10:02:00', N'{"id_prospecto":8,"activo":1}'),
    ('NEGOCIO',   10, 'INSERT', 5, '2025-03-09 13:40:00', NULL);
GO

INSERT INTO LOG_ACTIVIDAD (id_actividad, id_negocio, id_trabajador, fecha_completada, mensaje) VALUES
    (1,  1, 3, '2025-03-01 09:20:00', N'Actividad [Negocio creado] marcada como completada'),
